...
export interface RoxyGematriaProps extends ElementAttrs {
...
export const RoxyGematria = React.forwardRef<HTMLElement | null, RoxyGematriaProps>(
	function RoxyGematria({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-gematria', {
			ref: internal,
			className,
			style,
			...rest,
