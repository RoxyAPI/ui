...
export interface RoxyDoshaConstitutionProps extends ElementAttrs {
...
export const RoxyDoshaConstitution = React.forwardRef<HTMLElement | null, RoxyDoshaConstitutionProps>(
	function RoxyDoshaConstitution({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-dosha-constitution', {
			ref: internal,
			className,
			style,
			...rest,
