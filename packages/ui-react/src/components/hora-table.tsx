...
export const RoxyHoraTable = React.forwardRef<HTMLElement | null, RoxyHoraTableProps>(
	function RoxyHoraTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
