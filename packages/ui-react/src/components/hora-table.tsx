...
export interface RoxyHoraTableProps extends ElementAttrs {
...
export const RoxyHoraTable = React.forwardRef<HTMLElement | null, RoxyHoraTableProps>(
	function RoxyHoraTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-hora-table', {
			ref: internal,
			className,
			style,
			...rest,
