...
export const RoxyCrystalGrid = React.forwardRef<HTMLElement | null, RoxyCrystalGridProps>(
	function RoxyCrystalGrid({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
