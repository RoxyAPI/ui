...
export const RoxyShadbalaTable = React.forwardRef<HTMLElement | null, RoxyShadbalaTableProps>(
	function RoxyShadbalaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
