...
export const RoxyHeliacalTable = React.forwardRef<HTMLElement | null, RoxyHeliacalTableProps>(
	function RoxyHeliacalTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
