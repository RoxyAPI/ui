...
export interface RoxyHeliacalTableProps extends ElementAttrs {
...
export const RoxyHeliacalTable = React.forwardRef<HTMLElement | null, RoxyHeliacalTableProps>(
	function RoxyHeliacalTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-heliacal-table', {
			ref: internal,
			className,
			style,
			...rest,
