...
export const RoxyHeliacalTable = React.forwardRef<HTMLElement | null, RoxyHeliacalTableProps>(
	function RoxyHeliacalTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
