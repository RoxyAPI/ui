...
export const RoxyReferenceCard = React.forwardRef<HTMLElement | null, RoxyReferenceCardProps>(
	function RoxyReferenceCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
