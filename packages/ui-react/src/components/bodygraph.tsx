...
export const RoxyBodygraph = React.forwardRef<HTMLElement | null, RoxyBodygraphProps>(
	function RoxyBodygraph({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
