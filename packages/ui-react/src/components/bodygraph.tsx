...
export const RoxyBodygraph = React.forwardRef<HTMLElement | null, RoxyBodygraphProps>(
	function RoxyBodygraph({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
