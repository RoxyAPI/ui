...
export const RoxyCrystalCard = React.forwardRef<HTMLElement | null, RoxyCrystalCardProps>(
	function RoxyCrystalCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
