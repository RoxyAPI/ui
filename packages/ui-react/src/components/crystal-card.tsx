...
export const RoxyCrystalCard = React.forwardRef<HTMLElement | null, RoxyCrystalCardProps>(
	function RoxyCrystalCard({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
