...
export interface RoxyCrystalCardProps extends ElementAttrs {
...
export const RoxyCrystalCard = React.forwardRef<HTMLElement | null, RoxyCrystalCardProps>(
	function RoxyCrystalCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-crystal-card', {
			ref: internal,
			className,
			style,
			...rest,
