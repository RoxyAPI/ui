...
export const RoxyNatalChart = React.forwardRef<HTMLElement | null, RoxyNatalChartProps>(
	function RoxyNatalChart({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
