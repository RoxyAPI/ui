...
export const RoxyNatalChart = React.forwardRef<HTMLElement | null, RoxyNatalChartProps>(
	function RoxyNatalChart({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
