...
export interface RoxyFixedStarsProps extends ElementAttrs {
...
export const RoxyFixedStars = React.forwardRef<HTMLElement | null, RoxyFixedStarsProps>(
	function RoxyFixedStars({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-fixed-stars', {
			ref: internal,
			className,
			style,
			...rest,
