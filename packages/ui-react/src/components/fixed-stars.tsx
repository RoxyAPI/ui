...
export const RoxyFixedStars = React.forwardRef<HTMLElement | null, RoxyFixedStarsProps>(
	function RoxyFixedStars({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
