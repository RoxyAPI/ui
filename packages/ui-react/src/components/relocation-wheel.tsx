...
export const RoxyRelocationWheel = React.forwardRef<HTMLElement | null, RoxyRelocationWheelProps>(
	function RoxyRelocationWheel({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
