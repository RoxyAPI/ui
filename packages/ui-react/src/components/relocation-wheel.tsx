...
export const RoxyRelocationWheel = React.forwardRef<HTMLElement | null, RoxyRelocationWheelProps>(
	function RoxyRelocationWheel({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
