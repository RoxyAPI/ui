...
export interface RoxyRelocationWheelProps extends ElementAttrs {
...
export const RoxyRelocationWheel = React.forwardRef<HTMLElement | null, RoxyRelocationWheelProps>(
	function RoxyRelocationWheel({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-relocation-wheel', {
			ref: internal,
			className,
			style,
			...rest,
