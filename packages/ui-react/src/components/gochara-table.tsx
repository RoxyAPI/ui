...
export interface RoxyGocharaTableProps extends ElementAttrs {
...
export const RoxyGocharaTable = React.forwardRef<HTMLElement | null, RoxyGocharaTableProps>(
	function RoxyGocharaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-gochara-table', {
			ref: internal,
			className,
			style,
			...rest,
