...
export const RoxyGocharaTable = React.forwardRef<HTMLElement | null, RoxyGocharaTableProps>(
	function RoxyGocharaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
