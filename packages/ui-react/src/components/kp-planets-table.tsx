...
export const RoxyKpPlanetsTable = React.forwardRef<HTMLElement | null, RoxyKpPlanetsTableProps>(
	function RoxyKpPlanetsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
