...
export const RoxyKpChart = React.forwardRef<HTMLElement | null, RoxyKpChartProps>(
	function RoxyKpChart({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
