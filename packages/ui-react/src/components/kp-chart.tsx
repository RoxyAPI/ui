...
export interface RoxyKpChartProps extends ElementAttrs {
...
export const RoxyKpChart = React.forwardRef<HTMLElement | null, RoxyKpChartProps>(
	function RoxyKpChart({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-kp-chart', {
			ref: internal,
			className,
			style,
			...rest,
