...
export interface RoxyLuckPillarsProps extends ElementAttrs {
...
export const RoxyLuckPillars = React.forwardRef<HTMLElement | null, RoxyLuckPillarsProps>(
	function RoxyLuckPillars({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-luck-pillars', {
			ref: internal,
			className,
			style,
			...rest,
