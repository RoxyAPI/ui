...
export interface RoxyVedicAspectsProps extends ElementAttrs {
...
export const RoxyVedicAspects = React.forwardRef<HTMLElement | null, RoxyVedicAspectsProps>(
	function RoxyVedicAspects({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-vedic-aspects', {
			ref: internal,
			className,
			style,
			...rest,
