...
export const RoxyVedicAspects = React.forwardRef<HTMLElement | null, RoxyVedicAspectsProps>(
	function RoxyVedicAspects({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
