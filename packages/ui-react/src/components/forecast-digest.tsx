...
export const RoxyForecastDigest = React.forwardRef<HTMLElement | null, RoxyForecastDigestProps>(
	function RoxyForecastDigest({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
