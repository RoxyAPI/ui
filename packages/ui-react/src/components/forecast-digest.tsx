...
export interface RoxyForecastDigestProps extends ElementAttrs {
...
export const RoxyForecastDigest = React.forwardRef<HTMLElement | null, RoxyForecastDigestProps>(
	function RoxyForecastDigest({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-forecast-digest', {
			ref: internal,
			className,
			style,
			...rest,
