...
export const RoxyDreamCard = React.forwardRef<HTMLElement | null, RoxyDreamCardProps>(
	function RoxyDreamCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
