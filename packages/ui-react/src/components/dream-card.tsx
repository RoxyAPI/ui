...
export const RoxyDreamCard = React.forwardRef<HTMLElement | null, RoxyDreamCardProps>(
	function RoxyDreamCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
