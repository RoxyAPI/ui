...
export interface RoxyBhavChalitTableProps extends ElementAttrs {
...
export const RoxyBhavChalitTable = React.forwardRef<HTMLElement | null, RoxyBhavChalitTableProps>(
	function RoxyBhavChalitTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-bhav-chalit-table', {
			ref: internal,
			className,
			style,
			...rest,
