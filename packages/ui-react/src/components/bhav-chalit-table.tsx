...
export const RoxyBhavChalitTable = React.forwardRef<HTMLElement | null, RoxyBhavChalitTableProps>(
	function RoxyBhavChalitTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
