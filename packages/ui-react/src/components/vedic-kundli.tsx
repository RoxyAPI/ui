...
export const RoxyVedicKundli = React.forwardRef<HTMLElement | null, RoxyVedicKundliProps>(
	function RoxyVedicKundli({ data, className, style, chartStyle, chartReference, lagnaOverride, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
