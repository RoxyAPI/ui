...
export const RoxyEphemerisTable = React.forwardRef<HTMLElement | null, RoxyEphemerisTableProps>(
	function RoxyEphemerisTable({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
