...
export const RoxyEphemerisTable = React.forwardRef<HTMLElement | null, RoxyEphemerisTableProps>(
	function RoxyEphemerisTable({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
