...
export interface RoxyEphemerisTableProps extends ElementAttrs {
...
export const RoxyEphemerisTable = React.forwardRef<HTMLElement | null, RoxyEphemerisTableProps>(
	function RoxyEphemerisTable({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-ephemeris-table', {
			ref: internal,
			className,
			style,
			...rest,
