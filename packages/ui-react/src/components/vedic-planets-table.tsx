...
export const RoxyVedicPlanetsTable = React.forwardRef<HTMLElement | null, RoxyVedicPlanetsTableProps>(
	function RoxyVedicPlanetsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
