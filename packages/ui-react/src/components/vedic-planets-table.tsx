...
export interface RoxyVedicPlanetsTableProps extends ElementAttrs {
...
export const RoxyVedicPlanetsTable = React.forwardRef<HTMLElement | null, RoxyVedicPlanetsTableProps>(
	function RoxyVedicPlanetsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-vedic-planets-table', {
			ref: internal,
			className,
			style,
			...rest,
