...
export const RoxyLocalSpaceCompass = React.forwardRef<HTMLElement | null, RoxyLocalSpaceCompassProps>(
	function RoxyLocalSpaceCompass({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
