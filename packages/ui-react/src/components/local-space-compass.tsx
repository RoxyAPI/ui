...
export const RoxyLocalSpaceCompass = React.forwardRef<HTMLElement | null, RoxyLocalSpaceCompassProps>(
	function RoxyLocalSpaceCompass({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
