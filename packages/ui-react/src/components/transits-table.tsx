...
export const RoxyTransitsTable = React.forwardRef<HTMLElement | null, RoxyTransitsTableProps>(
	function RoxyTransitsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
