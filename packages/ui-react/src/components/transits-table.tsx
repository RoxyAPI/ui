...
export const RoxyTransitsTable = React.forwardRef<HTMLElement | null, RoxyTransitsTableProps>(
	function RoxyTransitsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-transits-table', {
			ref: internal,
			className,
			style,
			...rest,
