...
export const RoxyTransitsTable = React.forwardRef<HTMLElement | null, RoxyTransitsTableProps>(
	function RoxyTransitsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
