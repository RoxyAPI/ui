...
export const RoxySynastryChart = React.forwardRef<HTMLElement | null, RoxySynastryChartProps>(
	function RoxySynastryChart({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
