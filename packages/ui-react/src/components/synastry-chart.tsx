...
export const RoxySynastryChart = React.forwardRef<HTMLElement | null, RoxySynastryChartProps>(
	function RoxySynastryChart({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
