...
export const RoxyHexagram = React.forwardRef<HTMLElement | null, RoxyHexagramProps>(
	function RoxyHexagram({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
