...
export const RoxyHexagram = React.forwardRef<HTMLElement | null, RoxyHexagramProps>(
	function RoxyHexagram({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
