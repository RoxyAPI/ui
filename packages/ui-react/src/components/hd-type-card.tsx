...
export const RoxyHdTypeCard = React.forwardRef<HTMLElement | null, RoxyHdTypeCardProps>(
	function RoxyHdTypeCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
