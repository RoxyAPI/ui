...
export const RoxyBhavaBalaTable = React.forwardRef<HTMLElement | null, RoxyBhavaBalaTableProps>(
	function RoxyBhavaBalaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
