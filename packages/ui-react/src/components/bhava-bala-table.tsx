...
export interface RoxyBhavaBalaTableProps extends ElementAttrs {
...
export const RoxyBhavaBalaTable = React.forwardRef<HTMLElement | null, RoxyBhavaBalaTableProps>(
	function RoxyBhavaBalaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-bhava-bala-table', {
			ref: internal,
			className,
			style,
			...rest,
