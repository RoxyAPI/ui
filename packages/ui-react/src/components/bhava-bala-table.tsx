...
export const RoxyBhavaBalaTable = React.forwardRef<HTMLElement | null, RoxyBhavaBalaTableProps>(
	function RoxyBhavaBalaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
