...
export const RoxyTarotCard = React.forwardRef<HTMLElement | null, RoxyTarotCardProps>(
	function RoxyTarotCard({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
