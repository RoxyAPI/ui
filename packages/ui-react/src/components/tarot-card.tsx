...
export const RoxyTarotCard = React.forwardRef<HTMLElement | null, RoxyTarotCardProps>(
	function RoxyTarotCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
