...
export const RoxyNakshatraCard = React.forwardRef<HTMLElement | null, RoxyNakshatraCardProps>(
	function RoxyNakshatraCard({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
