...
export interface RoxyNakshatraCardProps extends ElementAttrs {
...
export const RoxyNakshatraCard = React.forwardRef<HTMLElement | null, RoxyNakshatraCardProps>(
	function RoxyNakshatraCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-nakshatra-card', {
			ref: internal,
			className,
			style,
			...rest,
