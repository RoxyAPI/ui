...
export const RoxyNakshatraCard = React.forwardRef<HTMLElement | null, RoxyNakshatraCardProps>(
	function RoxyNakshatraCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
