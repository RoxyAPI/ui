...
export interface RoxyKpFinanceCardProps extends ElementAttrs {
...
export const RoxyKpFinanceCard = React.forwardRef<HTMLElement | null, RoxyKpFinanceCardProps>(
	function RoxyKpFinanceCard({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-kp-finance-card', {
			ref: internal,
			className,
			style,
			...rest,
