...
export const RoxyForecastTimeline = React.forwardRef<HTMLElement | null, RoxyForecastTimelineProps>(
	function RoxyForecastTimeline({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
