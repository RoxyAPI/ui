...
export interface RoxyForecastTimelineProps extends ElementAttrs {
...
export const RoxyForecastTimeline = React.forwardRef<HTMLElement | null, RoxyForecastTimelineProps>(
	function RoxyForecastTimeline({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-forecast-timeline', {
			ref: internal,
			className,
			style,
			...rest,
