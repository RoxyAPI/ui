...
export const RoxyForecastTimeline = React.forwardRef<HTMLElement | null, RoxyForecastTimelineProps>(
	function RoxyForecastTimeline({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
