...
export const RoxyTarotCatalog = React.forwardRef<HTMLElement | null, RoxyTarotCatalogProps>(
	function RoxyTarotCatalog({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
