...
export const RoxyTarotCatalog = React.forwardRef<HTMLElement | null, RoxyTarotCatalogProps>(
	function RoxyTarotCatalog({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, ...rest }, ref) {
