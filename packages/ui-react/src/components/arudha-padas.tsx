...
export interface RoxyArudhaPadasProps extends ElementAttrs {
...
export const RoxyArudhaPadas = React.forwardRef<HTMLElement | null, RoxyArudhaPadasProps>(
	function RoxyArudhaPadas({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-arudha-padas', {
			ref: internal,
			className,
			style,
			...rest,
