...
export const RoxyHoroscopeCard = React.forwardRef<HTMLElement | null, RoxyHoroscopeCardProps>(
	function RoxyHoroscopeCard({ data, className, style, period, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
