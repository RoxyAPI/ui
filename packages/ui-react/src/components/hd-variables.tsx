...
export const RoxyHdVariables = React.forwardRef<HTMLElement | null, RoxyHdVariablesProps>(
	function RoxyHdVariables({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
