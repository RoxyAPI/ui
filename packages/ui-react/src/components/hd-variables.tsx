...
export interface RoxyHdVariablesProps extends ElementAttrs {
...
export const RoxyHdVariables = React.forwardRef<HTMLElement | null, RoxyHdVariablesProps>(
	function RoxyHdVariables({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-hd-variables', {
			ref: internal,
			className,
			style,
			...rest,
