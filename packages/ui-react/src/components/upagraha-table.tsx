...
export const RoxyUpagrahaTable = React.forwardRef<HTMLElement | null, RoxyUpagrahaTableProps>(
	function RoxyUpagrahaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
