...
export interface RoxyUpagrahaTableProps extends ElementAttrs {
...
export const RoxyUpagrahaTable = React.forwardRef<HTMLElement | null, RoxyUpagrahaTableProps>(
	function RoxyUpagrahaTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-upagraha-table', {
			ref: internal,
			className,
			style,
			...rest,
