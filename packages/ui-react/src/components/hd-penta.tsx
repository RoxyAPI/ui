...
export interface RoxyHdPentaProps extends ElementAttrs {
...
export const RoxyHdPenta = React.forwardRef<HTMLElement | null, RoxyHdPentaProps>(
	function RoxyHdPenta({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-hd-penta', {
			ref: internal,
			className,
			style,
			...rest,
