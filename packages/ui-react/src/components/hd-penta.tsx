...
export const RoxyHdPenta = React.forwardRef<HTMLElement | null, RoxyHdPentaProps>(
	function RoxyHdPenta({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
