...
export const RoxyPositionsTable = React.forwardRef<HTMLElement | null, RoxyPositionsTableProps>(
	function RoxyPositionsTable({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
