...
export interface RoxyPositionsTableProps extends ElementAttrs {
...
export const RoxyPositionsTable = React.forwardRef<HTMLElement | null, RoxyPositionsTableProps>(
	function RoxyPositionsTable({ data, className, style, heading, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-positions-table', {
			ref: internal,
			className,
			style,
			...rest,
