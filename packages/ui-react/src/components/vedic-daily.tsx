...
export interface RoxyVedicDailyProps extends ElementAttrs {
...
export const RoxyVedicDaily = React.forwardRef<HTMLElement | null, RoxyVedicDailyProps>(
	function RoxyVedicDaily({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-vedic-daily', {
			ref: internal,
			className,
			style,
			...rest,
