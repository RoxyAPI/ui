...
export const RoxyVedicDaily = React.forwardRef<HTMLElement | null, RoxyVedicDailyProps>(
	function RoxyVedicDaily({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
