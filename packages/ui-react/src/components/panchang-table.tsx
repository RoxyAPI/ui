...
export const RoxyPanchangTable = React.forwardRef<HTMLElement | null, RoxyPanchangTableProps>(
	function RoxyPanchangTable({ data, className, style, detail, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
