...
export const RoxyGunaMilan = React.forwardRef<HTMLElement | null, RoxyGunaMilanProps>(
	function RoxyGunaMilan({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
