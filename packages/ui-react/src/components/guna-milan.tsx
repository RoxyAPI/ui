...
export const RoxyGunaMilan = React.forwardRef<HTMLElement | null, RoxyGunaMilanProps>(
	function RoxyGunaMilan({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
