...
export interface RoxyKpRulingPlanetsProps extends ElementAttrs {
...
export const RoxyKpRulingPlanets = React.forwardRef<HTMLElement | null, RoxyKpRulingPlanetsProps>(
	function RoxyKpRulingPlanets({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-kp-ruling-planets', {
			ref: internal,
			className,
			style,
			...rest,
