...
export const RoxyKpRulingPlanets = React.forwardRef<HTMLElement | null, RoxyKpRulingPlanetsProps>(
	function RoxyKpRulingPlanets({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
