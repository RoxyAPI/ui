...
export interface RoxyBaziChartProps extends ElementAttrs {
...
export const RoxyBaziChart = React.forwardRef<HTMLElement | null, RoxyBaziChartProps>(
	function RoxyBaziChart({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-bazi-chart', {
			ref: internal,
			className,
			style,
			...rest,
