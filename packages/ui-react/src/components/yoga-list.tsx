...
export const RoxyYogaList = React.forwardRef<HTMLElement | null, RoxyYogaListProps>(
	function RoxyYogaList({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-yoga-list', {
			ref: internal,
			className,
			style,
			...rest,
