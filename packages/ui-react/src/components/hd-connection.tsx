...
export const RoxyHdConnection = React.forwardRef<HTMLElement | null, RoxyHdConnectionProps>(
	function RoxyHdConnection({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
