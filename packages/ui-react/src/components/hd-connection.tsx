...
export interface RoxyHdConnectionProps extends ElementAttrs {
...
export const RoxyHdConnection = React.forwardRef<HTMLElement | null, RoxyHdConnectionProps>(
	function RoxyHdConnection({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-hd-connection', {
			ref: internal,
			className,
			style,
			...rest,
