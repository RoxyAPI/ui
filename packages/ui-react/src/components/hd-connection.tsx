...
export const RoxyHdConnection = React.forwardRef<HTMLElement | null, RoxyHdConnectionProps>(
	function RoxyHdConnection({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
