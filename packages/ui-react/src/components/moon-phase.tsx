...
export const RoxyMoonPhase = React.forwardRef<HTMLElement | null, RoxyMoonPhaseProps>(
	function RoxyMoonPhase({ data, className, style, mode, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
