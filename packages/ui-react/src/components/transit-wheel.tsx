...
export const RoxyTransitWheel = React.forwardRef<HTMLElement | null, RoxyTransitWheelProps>(
	function RoxyTransitWheel({ data, className, style, heading, ascendant, houses, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, attribution, hideReadings, hideSections, ...rest }, ref) {
