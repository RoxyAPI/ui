...
export interface RoxyTransitWheelProps extends ElementAttrs {
...
export const RoxyTransitWheel = React.forwardRef<HTMLElement | null, RoxyTransitWheelProps>(
	function RoxyTransitWheel({ data, className, style, heading, ascendant, houses, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-transit-wheel', {
			ref: internal,
			className,
			style,
			...rest,
