...
export interface RoxyDreamSearchProps extends ElementAttrs {
...
export const RoxyDreamSearch = React.forwardRef<HTMLElement | null, RoxyDreamSearchProps>(
	function RoxyDreamSearch({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-dream-search', {
			ref: internal,
			className,
			style,
			...rest,
