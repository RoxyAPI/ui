...
export const RoxyDreamSearch = React.forwardRef<HTMLElement | null, RoxyDreamSearchProps>(
	function RoxyDreamSearch({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
