...
export const RoxyWesternPlanetsTable = React.forwardRef<HTMLElement | null, RoxyWesternPlanetsTableProps>(
	function RoxyWesternPlanetsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, specUrl, lang, submitLabel, attribution, hideReadings, ...rest }, ref) {
