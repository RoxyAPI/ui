...
export interface RoxyWesternPlanetsTableProps extends ElementAttrs {
...
export const RoxyWesternPlanetsTable = React.forwardRef<HTMLElement | null, RoxyWesternPlanetsTableProps>(
	function RoxyWesternPlanetsTable({ data, className, style, endpoint, method, publishableKey, baseUrl, submitUrl, submitContext, locationUrl, specUrl, lang, submitLabel, remember, attribution, hideReadings, hideSections, ...rest }, ref) {
		...
		return React.createElement('roxy-western-planets-table', {
			ref: internal,
			className,
			style,
			...rest,
