...
`;var Jt=["title","name","label","heading","overview","summary"],Bt=["imageUrl","image","icon","symbol"],Kt=["imageUrl","image"],Vt=6,x=class extends ${constructor(){super(...arguments);this.data=null;this.depth=0}render(){return this.data==null?d`<div class="roxy-empty" role="status">No data</div>`:this.depth>=Vt?d`<div class="roxy-empty" role="status">…</div>`:d`<div
			class="roxy-card"
		...
		`],z([J({attribute:!1})],x.prototype,"data",2),z([J({attribute:!1})],x.prototype,"depth",2),x=z([bt("roxy-data")],x);return Ct(Wt);})();
