...
export const fr: Record<ChromeString, string> = {
	...
	'Replace the sample key with your own publishable key from your RoxyAPI account.':
		'Remplacez la clé de démonstration par votre propre clé publiable, issue de votre compte RoxyAPI.',
	Severity: 'Gravité',
	Remedies: 'Remèdes',
	...
	// Feminine, so Douce, Moyenne and Violente below agree with the label they sit
	// under; caractère is masculine and would not.
	'Character of the number': 'Nature du nombre',
	Gentle: 'Douce',
	Indifferent: 'Moyenne',
	Violent: 'Violente',
	Center: 'Centre',
	...
	'Brahmasthan area': 'Surface du Brahmasthan',
	'Area of one marma': "Surface d'un Marma",
	...
	Factors: 'Facteurs',
	Weight: 'Pondération',
	'Note on the source': 'Note sur la source',
	...
	'Stem combination': 'Combinaison des Troncs',
	'Six combination': 'Six Harmonies',
	Trine: 'Trigone',
	Punishment: 'Punition',
	'Stem clash': 'Choc des Troncs',
	...
	Same: 'Même Branche',
	'Secret friend': 'Ami secret',
	Harm: 'Tort',
	Clash: 'Choc',

	// Luck pillars (Da Yun).
	'Luck pillars': 'Piliers de Chance',
	Starts: 'Débute',
	'Counted to': "Compté jusqu'à",
	Days: 'Jours',
	'Annual pillars': 'Piliers Annuels',
	...
	Traits: 'Traits',
	'Shared element': 'Élément partagé',
	...
	Avoiding: 'À éviter',
	'Lunar {{month}}/{{day}}': 'Lunaire {{month}}/{{day}}',
	'Lunar {{month}}/{{day}} (leap)': 'Lunaire {{month}}/{{day}} (intercalaire)',
	Favours: 'Favorable',
	Avoids: 'Déconseillé',
	Mansion: 'Demeure',
	Almanac: 'Almanach',
	...
	'{{direction}} group': 'Groupe {{direction}}',
	Trigram: 'Trigramme',
	Role: 'Rôle',
	'Year from {{date}}': 'Année depuis {{date}}',
	'Reassigned from {{value}}': 'Réattribué depuis {{value}}',
	Kua: 'Kua',
	'Eight mansions': 'Huit Maisons',
	Best: 'Meilleur',
	Worst: 'Pire',
	Sectors: 'Secteurs',

	// Flying Star (Xuan Kong) plate.
	'Mountain star': 'Étoile Montagne',
	'Water star': 'Étoile Eau',
	'Period star': 'Étoile Période',
	'Flying star chart': 'Carte des Étoiles Volantes',
	Facing: 'Façade',
	Sitting: 'Assise',
