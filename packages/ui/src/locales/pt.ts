...
export const pt: Record<ChromeString, string> = {
	...
	'Type a city, then pick it from the list.':
		'Digite uma cidade e escolha-a na lista.',
	Choose: 'Escolha',
	...
	'Replace the sample key with your own publishable key from your RoxyAPI account.':
		'Substitua a chave de exemplo pela sua própria chave publicável da sua conta RoxyAPI.',
	Severity: 'Gravidade',
	Remedies: 'Remédios',
	Exceptions: 'Exceções',
	...
	'No ascendant in this chart, so the houses are not numbered.':
		'Este mapa não tem ascendente, portanto as casas não são numeradas.',
	combust: 'combusto',
	'planetary war': 'guerra planetária',
	'planetary war with {{graha}}': 'guerra planetária com {{graha}}',
	'planetary war with {{graha}}, won by {{winner}}':
		'guerra planetária com {{graha}}, vencida por {{winner}}',
	'nakshatra lord {{graha}}': 'regente do nakshatra {{graha}}',
	...
	'Western planetary positions: each body with its sign, degree, house, essential dignity and motion. The dignity cell is blank for the lunar nodes, Chiron and Lilith, which rule no sign and therefore hold no dignity at all.':
		'Posições planetárias ocidentais: cada corpo com o seu signo, grau, casa, dignidade essencial e movimento. A célula de dignidade fica vazia para os nodos lunares, Quíron e Lilith, que não regem signo algum e por isso não têm dignidade.',
	Dignity: 'Dignidade',
	Degree: 'Grau',
	...
	'Twelve houses ranked by strength': 'Doze casas ordenadas por força',
	'Twelve houses ranked by strength on the {{system}} frame':
		'Doze casas ordenadas por força no sistema {{system}}',
	'Component legend': 'Legenda das componentes',
	...
	Shadbala: 'Shadbala',
	'Shadbala planetary strength': 'Força planetária Shadbala',
	'{{count}} planets ranked by strength':
		'{{count}} planetas ordenados por força',
	...
	'Gochara houses are counted from the natal Moon in {{sign}}.':
		'As casas de Gochara são contadas desde a Lua natal em {{sign}}.',
	'house {{n}} from the Moon': 'casa {{n}} desde a Lua',
	'house {{n}} from the Lagna': 'casa {{n}} desde o Lagna',
	...
	'Vedic daily': 'Dia védico',
	'Vedic daily reading': 'Leitura védica do dia',
	'{{supportive}} of {{evaluated}} grahas support this day':
		'{{supportive}} de {{evaluated}} grahas apoiam este dia',
	'Born with the Moon in {{rashi}}, nakshatra {{nakshatra}}':
		'Nascido com a Lua em {{rashi}}, nakshatra {{nakshatra}}',
	'{{component}} unavailable: {{reason}}':
		'{{component}} indisponível: {{reason}}',
	Paksha: 'Paksha',
	'until {{time}}': 'até {{time}}',
	'Grahas today': 'Grahas de hoje',
	'Each transiting graha with its sign, the house it occupies from the natal Moon, its bindus, its kaksha and the state the classical rules give it.':
		'Cada graha em trânsito com o seu signo, a casa que ocupa desde a Lua natal, os seus bindus, a sua kaksha e o estado que as regras clássicas lhe dão.',
	Kaksha: 'Kaksha',
	State: 'Estado',
	Favourable: 'Favorável',
	Underdelivered: 'Insuficiente',
	...
	Moderate: 'Moderado',
	Weak: 'Fraco',
	'Tara and Chandrabala': 'Tara e Chandrabala',
	'Moon in {{sign}}, house {{n}}': 'Lua em {{sign}}, casa {{n}}',
	...
	'Lucky color': 'Cor da sorte',
	'Lucky days': 'Dias de sorte',
	'Best with': 'Melhor com',
	Phase: 'Fase',
	'Active transits': 'Trânsitos ativos',
	...
	'marks a pada that fell in its own bhava or the seventh from it and was moved to the tenth from there, as the classical rule requires. {{count}} of {{total}} padas here.':
		'assinala um pada que caía no seu próprio bhava ou no sétimo a partir dele e foi deslocado para o décimo a partir daí, como exige a regra clássica. Aqui {{count}} de {{total}} padas.',
	'The twelve Arudha padas: each pada with its bhava, the bhava sign and its lord, the sign the lord occupies, the sign the pada falls in, which house from the Lagna that is, whether the classical exception was applied, and what the pada is read for.':
		'Os doze Arudha padas: cada pada com o seu bhava, o signo do bhava e o seu regente, o signo que o regente ocupa, o signo em que o pada cai, que casa desde o Lagna é, se a exceção clássica se aplicou, e para que se lê o pada.',
	'Bhava rashi': 'Rashi do bhava',
	'Lord rashi': 'Rashi do regente',
	'Pada rashi': 'Rashi do pada',
	'From Lagna': 'Desde o Lagna',
	Lagna: 'Lagna',
	...
	'Baladi: the five age states, set by degree within the sign':
		'Baladi: os cinco estados de idade, definidos pelo grau dentro do signo',
	'Jagradadi: the three waking states, set by sign dignity. The seven classical grahas only':
		'Jagradadi: os três estados de vigília, definidos pela dignidade por signo. Apenas os sete grahas clássicos',
	'Deeptadi: the nine dispositional states, set by sign dignity. The seven classical grahas only':
		'Deeptadi: os nove estados de disposição, definidos pela dignidade por signo. Apenas os sete grahas clássicos',
	Retro: 'Retro',
	'Combust grahas': 'Grahas combustos',
	'{{distance}} deg from Sun, within {{orb}} deg orb':
		'{{distance}} graus do Sol, dentro de um orbe de {{orb}} graus',
	'Planetary wars': 'Guerras planetárias',
	'{{first}} vs {{second}}': '{{first}} contra {{second}}',
	'{{distance}} deg apart': '{{distance}} graus de separação',
	'{{graha}} wins': '{{graha}} vence',
	Interpretations: 'Interpretações',
	'Rashi.': 'Rashi.',
	'Nakshatra.': 'Nakshatra.',
	'Bhava significations': 'Significações dos bhavas',
	Yogas: 'Yogas',
	Ashtakavarga: 'Ashtakavarga',
	'Ashtakavarga grid': 'Grelha de ashtakavarga',
	'Ashtakavarga views': 'Vistas de ashtakavarga',
	Sarvashtakavarga: 'Sarvashtakavarga',
	Bhinnashtakavarga: 'Bhinnashtakavarga',
	Reduced: 'Reduzido',
	'Reduced SAV': 'SAV reduzido',
	'Shodhya Pinda': 'Shodhya Pinda',
	'{{count}} signs': '{{count}} signos',
	'Fewer bindus': 'Menos bindus',
	'More bindus': 'Mais bindus',
	Bindus: 'Bindus',
	'Rashi Pinda': 'Rashi Pinda',
	'Graha Pinda': 'Graha Pinda',
	'No sarvashtakavarga data': 'Sem dados de sarvashtakavarga',
	'No bhinnashtakavarga data': 'Sem dados de bhinnashtakavarga',
	'No reduced ashtakavarga data': 'Sem dados de ashtakavarga reduzido',
	'No bindu data': 'Sem dados de bindus',
	'No shodhya pinda data': 'Sem dados de shodhya pinda',
	'Sarvashtakavarga: each of the twelve signs and the bindus all planets contribute to it, with a grand total.':
		'Sarvashtakavarga: cada um dos doze signos e os bindus que todos os planetas lhe dão, com um total geral.',
	'Shodhya Pinda: each planet with its Rashi Pinda, Graha Pinda and Shodhya Pinda strength scores.':
		'Shodhya Pinda: cada planeta com as suas pontuações de força de Rashi Pinda, Graha Pinda e Shodhya Pinda.',
	'Detected yogas': 'Yogas detetados',
	...
	'Classical family': 'Família clássica',
	Effects: 'Efeitos',
	'Every classical condition is satisfied by this chart.':
		'Este mapa cumpre todas as condições clássicas.',
	'The rule matched, but a stronger family silences it under the classical precedence norms. Each card names the family that took precedence.':
		'A regra aplicou-se, mas uma família mais forte silencia-a segundo as normas clássicas de precedência. Cada cartão indica a família que teve precedência.',
	'At least one classical condition fails. Read the evidence for which.':
		'Pelo menos uma condição clássica falha. A evidência indica qual.',
	Synastry: 'Sinastria',
	'Synastry compatibility chart': 'Mapa de compatibilidade de sinastria',
	'Synastry dual wheel': 'Roda dupla de sinastria',
	'Dual chart wheel comparing two natal charts':
		'Roda dupla que compara dois mapas natais',
	'Synastry response missing planet positions.':
		'A resposta de sinastria não traz as posições planetárias.',
	'A current {{endpoint}} response carries {{first}} and {{second}}, and the inter-aspect readings below still work without them.':
		'Uma resposta atual de {{endpoint}} traz {{first}} e {{second}}, e as leituras de interaspetos abaixo funcionam na mesma sem elas.',
	'Inter-aspects': 'Interaspetos',
	'Inter-aspect summary': 'Resumo dos interaspetos',
	'In this pairing': 'Neste par',
	'All {{count}} inter-aspects': 'Os {{count}} interaspetos',
	'orb {{orb}}° · str {{strength}}': 'orbe {{orb}}° · força {{strength}}',
	'ASC{{n}}': 'ASC{{n}}',
	'Person {{n}}': 'Pessoa {{n}}',
	'Score {{score}} of 100': 'Pontuação {{score}} de 100',
	...
	'Mayan day sign': 'Signo do dia maia',
	'Classic spelling': 'Grafia clássica',
	'Highland spelling': 'Grafia das terras altas',
	Coefficient: 'Coeficiente',
	'Day sign': 'Signo do dia',
	Trecena: 'Trezena',
	'Day {{n}} of {{total}}': 'Dia {{n}} de {{total}}',
	'Ruling sign': 'Signo regente',
	Correlation: 'Correlação',
	Haab: 'Haab',
	'Day of year': 'Dia do ano',
	'Long Count': 'Contagem Longa',
	'Calendar Round': 'Roda Calendárica',
	...
	Violent: 'Violenta',
	Center: 'Centro',
	'Conception arm': 'Braço da concepção',
	'Destiny arm': 'Braço do destino',
	...
	'Vastu grid, north at the top and west on the left':
		'Grade vastu, o norte em cima e o oeste à esquerda',
	'Entrance pada': 'Pada da entrada',
	Devata: 'Devata',
	Brahmasthan: 'Brahmasthan',
	'Brahmasthan area': 'Área do Brahmasthan',
	'Area of one marma': 'Área de um Marma',
	'Crossing points': 'Pontos de cruzamento',
	'Outside the plot': 'Fora do terreno',
	'Door pada': 'Pada da porta',
	'Recommended padas': 'Padas recomendados',
	'Counted from': 'Contado a partir de',
	Side: 'Lado',
	Perimeter: 'Perímetro',
	'Inner ring': 'Anel interior',
	'Inner corner': 'Canto interior',
	Mixed: 'Misto',

	// Kabbalah: the gematria calculator.
	Gematria: 'Gematria',
	Cipher: 'Cifra',
	'Cipher values': 'Valores por cifra',
	Value: 'Valor',
	'Also published': 'Também publicados',
	Tradition: 'Tradição',
	Source: 'Fonte',
	Letters: 'Letras',
	...
	Output: 'Resultado',
	'Latin ciphers': 'Cifras latinas',
	'Equal values': 'Valores iguais',
	Word: 'Palavra',
	Meaning: 'Significado',
	...
	Factors: 'Fatores',
	Weight: 'Peso',
	'Note on the source': 'Nota sobre a fonte',
	'Strongest graha': 'Graha mais forte',
	Rank: 'Posição',
	'{{value}} virupas': '{{value}} virupas',
	Humours: 'Humores',
	'Planetary humours': 'Humores dos grahas',
	Dhatu: 'Dhatu',
	...
	// BaZi chart.
	'Four pillars': 'Quatro Pilares',
	'Day Master': 'Mestre do Dia',
	'Hidden stems': 'Troncos ocultos',
	'Na Yin': 'Na Yin',
	Interactions: 'Interações',

	// BaZi interaction categories.
	'Stem combination': 'Combinação de Troncos',
	'Six combination': 'Seis Harmonias',
	Trine: 'Três Harmonias',
	Punishment: 'Castigo',
	...
	Same: 'Mesmo Ramo',
	'Secret friend': 'Seis Harmonias',
	Harm: 'Seis Danos',
	Clash: 'Seis Choques',

	// Luck pillars (Da Yun).
	'Luck pillars': 'Pilares de Sorte',
	Starts: 'Início',
	'Counted to': 'Contado até',
	Days: 'Dias',
	'Annual pillars': 'Pilares Anuais',
	...
	'Shared element': 'Elemento compartilhado',
	...
	'Lunar {{month}}/{{day}} (leap)': 'Lunar {{month}}/{{day}} (bissexto)',
	Favours: 'Favorece',
	Avoids: 'Evita',
	Mansion: 'Mansão',
	Almanac: 'Almanaque',
	...
	'{{direction}} group': 'Grupo {{direction}}',
	Trigram: 'Trigrama',
	Role: 'Papel',
	'Year from {{date}}': 'Ano a partir de {{date}}',
	'Reassigned from {{value}}': 'Reatribuído de {{value}}',
	Kua: 'Kua',
	'Eight mansions': 'Oito Mansões',
	Best: 'Melhor',
	Worst: 'Pior',
	Sectors: 'Setores',

	// Flying Star (Xuan Kong) plate.
	'Mountain star': 'Estrela Montanha',
	'Water star': 'Estrela Água',
	'Period star': 'Estrela Período',
	'Flying star chart': 'Mapa de Estrelas Voadoras',
	Facing: 'Frente',
	Sitting: 'Traseira',
	Straddling: 'Limítrofe',
	'Period {{n}}': 'Período {{n}}',
};
