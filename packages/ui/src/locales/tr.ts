...
export const tr: Record<ChromeString, string> = {
	...
	'Mayan day sign': 'Maya gün işareti',
	'Classic spelling': 'Klasik yazım',
	'Highland spelling': 'Dağlık bölge yazımı',
	Coefficient: 'Katsayı',
	'Day sign': 'Gün işareti',
	Trecena: 'Trecena',
	'Day {{n}} of {{total}}': '{{total}} günün {{n}}. günü',
	'Ruling sign': 'Yöneten işaret',
	Correlation: 'Korelasyon',
	Haab: 'Haab',
	'Day of year': 'Yılın günü',
	'Long Count': 'Uzun Sayım',
	'Calendar Round': 'Calendar Round',
	'Lord of the Night': 'Gece Efendisi',
	'Year Bearer': 'Yıl taşıyıcısı',
	'Mayan cross': 'Maya haçı',
	'Offset in days': 'Gün farkı',
	'Character of the number': 'Sayının karakteri',
	Gentle: 'Yumuşak',
	Indifferent: 'Orta',
	Violent: 'Şiddetli',
	Center: 'Merkez',
	'Conception arm': 'Döllenme kolu',
	'Destiny arm': 'Kader kolu',
	'Left arm': 'Sol kol',
	'Right arm': 'Sağ kol',
	...
	'Vastu mandala': 'Vastu mandalası',
	'Vastu grid, north at the top and west on the left':
		'Vastu ızgarası, kuzey üstte ve batı solda',
	'Entrance pada': 'Giriş padası',
	Devata: 'Devata',
	Brahmasthan: 'Brahmasthan',
	'Brahmasthan area': 'Brahmasthan alanı',
	'Area of one marma': 'Bir Marma alanı',
	'Crossing points': 'Kesişme noktaları',
	'Outside the plot': 'Arsanın dışında',
	'Door pada': 'Kapı padası',
	'Recommended padas': 'Önerilen padalar',
	'Counted from': 'Sayım başlangıcı',
	Side: 'Taraf',
	Perimeter: 'Dış çember',
	'Inner ring': 'İç halka',
	'Inner corner': 'İç köşe',
	Mixed: 'Karışık',

	// Kabbalah: the gematria calculator.
	Gematria: 'Gematria',
	Cipher: 'Sayım yöntemi',
	'Cipher values': 'Yönteme göre değerler',
	Value: 'Değer',
	'Also published': 'Ayrıca yayımlanan',
	Tradition: 'Gelenek',
	Source: 'Kaynak',
	Letters: 'Harfler',
	'Final form': 'Sonda gelen biçim',
	Spellings: 'Yazımlar',
	Chosen: 'Seçilen',
	Substitutions: 'Harf değiştirmeleri',
	Output: 'Sonuç',
	'Latin ciphers': 'Latin sayım yöntemleri',
	'Equal values': 'Eşit değerler',
	Word: 'Sözcük',
	Meaning: 'Anlam',

	// Ayurveda: the constitution card. The three humour NAMES are absent by design,
	// because the API never translates them.
	'Ayurvedic constitution': 'Ayurvedik bünye',
	Dominant: 'Baskın',
	Secondary: 'İkincil',
	Factors: 'Etkenler',
	Weight: 'Ağırlık',
	'Note on the source': 'Kaynak notu',
	'Strongest graha': 'En güçlü graha',
	Rank: 'Sıra',
	'{{value}} virupas': '{{value}} virupa',
	Humours: 'Doshalar',
