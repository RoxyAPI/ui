...
export const hi: Record<ChromeString, string> = {
	...
	'Vedic daily': 'वैदिक दैनिक',
	'Vedic daily reading': 'वैदिक दैनिक फलादेश',
	'{{supportive}} of {{evaluated}} grahas support this day':
		'{{evaluated}} में से {{supportive}} ग्रह इस दिन का समर्थन करते हैं',
	'Born with the Moon in {{rashi}}, nakshatra {{nakshatra}}':
		'जन्म चंद्र {{rashi}} में, नक्षत्र {{nakshatra}}',
	'{{component}} unavailable: {{reason}}':
		'{{component}} उपलब्ध नहीं: {{reason}}',
	Paksha: 'पक्ष',
	'until {{time}}': '{{time}} तक',
	'Grahas today': 'आज के ग्रह',
	'Each transiting graha with its sign, the house it occupies from the natal Moon, its bindus, its kaksha and the state the classical rules give it.':
		'प्रत्येक गोचर ग्रह उसकी राशि, जन्म चंद्र से भाव, बिंदु, कक्षा और शास्त्रीय नियमों से प्राप्त स्थिति के साथ।',
	Kaksha: 'कक्षा',
	State: 'स्थिति',
	Favourable: 'अनुकूल',
	Underdelivered: 'अल्पफल',
	Obstructed: 'बाधित',
	Void: 'निष्फल',
	Aggravated: 'उग्र',
	...
	Moderate: 'मध्यम',
	Weak: 'निर्बल',
	'Tara and Chandrabala': 'तारा और चंद्रबल',
	'Moon in {{sign}}, house {{n}}': 'चंद्र {{sign}} में, भाव {{n}}',
	'Ashtama Chandra': 'अष्टम चंद्र',
	Drivers: 'सहायक',
	Cautions: 'सावधानियां',
	...
	'Mayan day sign': 'माया दिन-चिह्न',
	'Classic spelling': 'शास्त्रीय वर्तनी',
	'Highland spelling': 'उच्चभूमि वर्तनी',
	Coefficient: 'गुणांक',
	'Day sign': 'दिन का चिह्न',
	Trecena: 'त्रेसेना',
	'Day {{n}} of {{total}}': '{{total}} में से दिन {{n}}',
	'Ruling sign': 'अधिपति चिह्न',
	Correlation: 'सहसंबंध',
	Haab: 'हाब',
	'Day of year': 'वर्ष का दिन',
	'Long Count': 'लॉन्ग काउंट',
	'Calendar Round': 'कैलेंडर चक्र',
	'Lord of the Night': 'रात्रि का स्वामी',
	'Year Bearer': 'वर्ष-वाहक',
	'Mayan cross': 'माया क्रॉस',
	'Offset in days': 'दिनों का अंतर',
	'Character of the number': 'संख्या का स्वभाव',
	Gentle: 'सौम्य',
	Indifferent: 'मध्य',
	Violent: 'उग्र',
	Center: 'केंद्र',
	'Conception arm': 'गर्भाधान भुजा',
	'Destiny arm': 'नियति भुजा',
	'Left arm': 'बायीं भुजा',
	'Right arm': 'दायीं भुजा',
	...
	'Vastu mandala': 'वास्तु मण्डल',
	'Vastu grid, north at the top and west on the left':
		'वास्तु ग्रिड, उत्तर ऊपर और पश्चिम बायीं ओर',
	'Entrance pada': 'प्रवेश पद',
	Devata: 'देवता',
	Brahmasthan: 'ब्रह्मस्थान',
	'Brahmasthan area': 'ब्रह्मस्थान का क्षेत्रफल',
	'Area of one marma': 'एक मर्म का क्षेत्रफल',
	'Crossing points': 'प्रतिच्छेद बिंदु',
	'Outside the plot': 'भूखंड के बाहर',
	'Door pada': 'द्वार का पद',
	'Recommended padas': 'अनुशंसित पद',
	'Counted from': 'गणना का आरंभ',
	Side: 'दिशा',
	Perimeter: 'परिधि',
	'Inner ring': 'भीतरी वलय',
	'Inner corner': 'भीतरी कोण',
	Mixed: 'मिश्रित',

	// Kabbalah: the gematria calculator.
	Gematria: 'गेमट्रिया',
	Cipher: 'गणना पद्धति',
	'Cipher values': 'पद्धति के अनुसार मान',
	Value: 'मान',
	'Also published': 'अन्य प्रकाशित मान',
	Tradition: 'परंपरा',
	Source: 'स्रोत',
	Letters: 'अक्षर',
	'Final form': 'अंत्य रूप',
	Spellings: 'वर्तनियाँ',
	Chosen: 'चयनित',
	Substitutions: 'प्रतिस्थापन',
	Output: 'परिणाम',
	'Latin ciphers': 'लैटिन गणना पद्धतियाँ',
	'Equal values': 'समान मान',
	Word: 'शब्द',
	Meaning: 'अर्थ',

	// Ayurveda: the constitution card. The three humour NAMES are absent by design,
	// because the API never translates them.
	'Ayurvedic constitution': 'आयुर्वेदिक प्रकृति',
	Dominant: 'प्रधान',
	Secondary: 'गौण',
	Factors: 'कारक',
	Weight: 'भारांक',
	'Note on the source': 'स्रोत पर टिप्पणी',
	'Strongest graha': 'सबसे बलवान ग्रह',
	Rank: 'क्रम',
	'{{value}} virupas': '{{value}} विरूप',
	Humours: 'दोष',
