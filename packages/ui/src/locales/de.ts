...
export const de: Record<ChromeString, string> = {
	...
	'Replace the sample key with your own publishable key from your RoxyAPI account.':
		'Ersetzen Sie den Beispielschlüssel durch Ihren eigenen veröffentlichbaren Schlüssel aus Ihrem RoxyAPI-Konto.',
	...
	'Vedic daily': 'Vedischer Tag',
	'Vedic daily reading': 'Vedische Tagesdeutung',
	'{{supportive}} of {{evaluated}} grahas support this day':
		'{{supportive}} von {{evaluated}} Grahas stützen diesen Tag',
	'Born with the Moon in {{rashi}}, nakshatra {{nakshatra}}':
		'Geboren mit dem Mond in {{rashi}}, Nakshatra {{nakshatra}}',
	'{{component}} unavailable: {{reason}}':
		'{{component}} nicht verfügbar: {{reason}}',
	Paksha: 'Paksha',
	'until {{time}}': 'bis {{time}}',
	'Grahas today': 'Grahas heute',
	'Each transiting graha with its sign, the house it occupies from the natal Moon, its bindus, its kaksha and the state the classical rules give it.':
		'Jeder transitierende Graha mit Zeichen, dem Haus vom Radix-Mond aus, seinen Bindus, seiner Kaksha und dem Zustand, den die klassischen Regeln ihm geben.',
	Kaksha: 'Kaksha',
	State: 'Zustand',
	Favourable: 'Günstig',
	Underdelivered: 'Unterliefert',
	...
	Moderate: 'Mittel',
	Weak: 'Schwach',
	'Tara and Chandrabala': 'Tara und Chandrabala',
	'Moon in {{sign}}, house {{n}}': 'Mond in {{sign}}, Haus {{n}}',
	...
	Yearly: 'Jahreshoroskop',
	'Sign ingress': 'Zeichenwechsel',
	'Retrograde station': 'Station',
	'Lunar phase': 'Mondphase',
	Eclipse: 'Finsternis',
	'Solar season': 'Sonnenwechsel',
	'through {{date}}': 'bis {{date}}',
	Themes: 'Themen',
	'Key periods': 'Wichtige Zeiten',
	Eclipses: 'Finsternisse',
	Retrogrades: 'Rückläufigkeiten',
	'Best months': 'Beste Monate',
	'{{count}} harmonious aspects': '{{count}} harmonische Aspekte',
	'Year boundary': 'Jahresbeginn',
	'Day boundary': 'Tagesbeginn',
	'Hour clock': 'Zeitbasis',
	...
	'{{first}} in the houses of {{second}}':
		'{{first}} in den Häusern von {{second}}',
	'Own house': 'Eigenes Haus',
	...
	'Mayan day sign': 'Maya-Tageszeichen',
	'Classic spelling': 'Klassische Schreibweise',
	'Highland spelling': 'Hochland-Schreibweise',
	Coefficient: 'Zahl des Tages',
	'Day sign': 'Tageszeichen',
	Trecena: 'Trecena',
	'Day {{n}} of {{total}}': 'Tag {{n}} von {{total}}',
	'Ruling sign': 'Herrschendes Zeichen',
	Correlation: 'Korrelation',
	Haab: 'Haab',
	'Day of year': 'Tag im Jahr',
	'Long Count': 'Lange Zählung',
	'Calendar Round': 'Kalenderrunde',
	'Lord of the Night': 'Herr der Nacht',
	'Year Bearer': 'Jahresträger',
	'Mayan cross': 'Maya-Kreuz',
	'Offset in days': 'Abstand in Tagen',
	'Character of the number': 'Charakter der Zahl',
	Gentle: 'Sanft',
	Indifferent: 'Mittel',
	Violent: 'Heftig',
	Center: 'Zentrum',
	'Conception arm': 'Empfängnisarm',
	'Destiny arm': 'Schicksalsarm',
	'Left arm': 'Linker Arm',
	...
	'Vastu mandala': 'Vastu-Mandala',
	'Vastu grid, north at the top and west on the left':
		'Vastu-Raster, Norden oben und Westen links',
	'Entrance pada': 'Eingangs-Pada',
	Devata: 'Devata',
	Brahmasthan: 'Brahmasthan',
	'Brahmasthan area': 'Fläche des Brahmasthan',
	'Area of one marma': 'Fläche eines Marma',
	'Crossing points': 'Kreuzungspunkte',
	'Outside the plot': 'Außerhalb des Grundstücks',
	'Door pada': 'Pada des Haupteingangs',
	'Recommended padas': 'Empfohlene Padas',
	'Counted from': 'Gezählt ab',
	Side: 'Seite',
	Perimeter: 'Außenring',
	...
	Gematria: 'Gematrie',
	Cipher: 'Zählweise',
	'Cipher values': 'Werte nach Zählweise',
	Value: 'Wert',
	'Also published': 'Ebenfalls veröffentlicht',
	Tradition: 'Tradition',
	Source: 'Quelle',
	Letters: 'Buchstaben',
	'Final form': 'Schlussform',
	Spellings: 'Schreibweisen',
	Chosen: 'Gewählt',
	Substitutions: 'Buchstabentausch',
	Output: 'Ergebnis',
	'Latin ciphers': 'Lateinische Zählweisen',
	'Equal values': 'Gleiche Werte',
	Word: 'Wort',
	Meaning: 'Bedeutung',

	// Ayurveda: the constitution card. The three humour NAMES are absent by design,
	// because the API never translates them.
	'Ayurvedic constitution': 'Ayurvedische Konstitution',
	Dominant: 'Vorherrschend',
	Secondary: 'Zweitstärkstes',
	Factors: 'Faktoren',
	Weight: 'Gewichtung',
	'Note on the source': 'Anmerkung zur Quelle',
	'Strongest graha': 'Stärkster Graha',
	Rank: 'Rang',
	'{{value}} virupas': '{{value}} Virupas',
	Humours: 'Doshas',
	'Planetary humours': 'Doshas der Grahas',
	Dhatu: 'Dhatu',
	...
	// BaZi chart.
	'Four pillars': 'Vier Pfeiler',
	'Day Master': 'Tagesmeister',
	'Hidden stems': 'Verborgene Stämme',
	'Na Yin': 'Na Yin',
	Interactions: 'Wechselwirkungen',

	// BaZi interaction categories.
	'Stem combination': 'Stem combination',
	'Six combination': 'Sechs Harmonien',
	Trine: 'Drei Harmonien',
	Punishment: 'Strafe',
	'Stem clash': 'Stammkonflikt',
	...
	Same: 'Gleicher Zweig',
	'Secret friend': 'Sechs Harmonien',
	Harm: 'Sechs Schädigungen',
	Clash: 'Sechs Konflikte',

	// Luck pillars (Da Yun).
	'Luck pillars': 'Glückssäulen',
	Starts: 'Beginn',
	'Counted to': 'Gezählt bis',
	Days: 'Tage',
	'Annual pillars': 'Jahrespfeiler',
	'{{start}} to {{end}}': '{{start}} bis {{end}}',
	'{{years}}y {{months}}m': '{{years}} J. {{months}} M.',
	Forward: 'Vorwärts',
	Backward: 'Rückwärts',
	...
	'Shared element': 'Gemeinsame Phase',
	...
	Avoiding: 'Vermeidung',
	'Lunar {{month}}/{{day}}': 'Mond {{month}}/{{day}}',
	'Lunar {{month}}/{{day}} (leap)': 'Mond {{month}}/{{day}} (Schaltmonat)',
	Favours: 'Günstig für',
	Avoids: 'Ungünstig für',
	Mansion: 'Wohnsitz',
	Almanac: 'Almanach',

	// Kua number and Eight Mansions.
	'{{direction}} group': '{{direction}}-Gruppe',
	Trigram: 'Trigramm',
	Role: 'Rolle',
	'Year from {{date}}': 'Jahr ab {{date}}',
	'Reassigned from {{value}}': 'Umgewandelt aus {{value}}',
	Kua: 'Kua',
	'Eight mansions': 'Acht Häuser',
	Best: 'Bester Sektor',
	Worst: 'Schlechtester Sektor',
	Sectors: 'Sektoren',

	// Flying Star (Xuan Kong) plate.
	'Mountain star': 'Bergstern',
	'Water star': 'Wasserstern',
	'Period star': 'Periodenstern',
	'Flying star chart': 'Fliegende-Sterne-Chart',
	Facing: 'Front',
	Sitting: 'Sitz',
	Straddling: 'Grenzfall',
	'Period {{n}}': 'Periode {{n}}',
};
