...
export const es: Record<ChromeString, string> = {
	...
	'Replace the sample key with your own publishable key from your RoxyAPI account.':
		'Sustituye la clave de ejemplo por tu propia clave publicable de tu cuenta de RoxyAPI.',
	Severity: 'Gravedad',
	Remedies: 'Remedios',
	...
	'Vedic daily': 'Día védico',
	'Vedic daily reading': 'Lectura védica del día',
	'{{supportive}} of {{evaluated}} grahas support this day':
		'{{supportive}} de {{evaluated}} grahas apoyan este día',
	'Born with the Moon in {{rashi}}, nakshatra {{nakshatra}}':
		'Nacido con la Luna en {{rashi}}, nakshatra {{nakshatra}}',
	'{{component}} unavailable: {{reason}}':
		'{{component}} no disponible: {{reason}}',
	Paksha: 'Paksha',
	'until {{time}}': 'hasta {{time}}',
	'Grahas today': 'Grahas de hoy',
	'Each transiting graha with its sign, the house it occupies from the natal Moon, its bindus, its kaksha and the state the classical rules give it.':
		'Cada graha en tránsito con su signo, la casa que ocupa desde la Luna natal, sus bindus, su kaksha y el estado que le dan las reglas clásicas.',
	Kaksha: 'Kaksha',
	State: 'Estado',
	...
	Moderate: 'Moderado',
	Weak: 'Débil',
	'Tara and Chandrabala': 'Tara y Chandrabala',
	'Moon in {{sign}}, house {{n}}': 'Luna en {{sign}}, casa {{n}}',
	...
	'ASC{{n}}': 'ASC{{n}}',
	'Person {{n}}': 'Persona {{n}}',
	'Score {{score}} of 100': 'Puntuación {{score}} de 100',
	...
	'Mayan day sign': 'Signo del día maya',
	'Classic spelling': 'Grafía clásica',
	'Highland spelling': 'Grafía de las tierras altas',
	Coefficient: 'Coeficiente',
	'Day sign': 'Signo del día',
	Trecena: 'Trecena',
	...
	'Long Count': 'Cuenta Larga',
	'Calendar Round': 'Rueda Calendárica',
	...
	Violent: 'Violenta',
	Center: 'Centro',
	'Conception arm': 'Brazo de la concepción',
	'Destiny arm': 'Brazo del destino',
	...
	'Vastu grid, north at the top and west on the left':
		'Cuadrícula vastu, el norte arriba y el oeste a la izquierda',
	'Entrance pada': 'Pada de la entrada',
	Devata: 'Devata',
	Brahmasthan: 'Brahmasthan',
	'Brahmasthan area': 'Superficie del Brahmasthan',
	'Area of one marma': 'Superficie de un Marma',
	'Crossing points': 'Puntos de cruce',
	'Outside the plot': 'Fuera del terreno',
	'Door pada': 'Pada de la puerta',
	...
	Gematria: 'Gematría',
	Cipher: 'Cifrado',
	'Cipher values': 'Valores por cifrado',
	Value: 'Valor',
	'Also published': 'También publicados',
	Tradition: 'Tradición',
	Source: 'Fuente',
	Letters: 'Letras',
	...
	Output: 'Resultado',
	'Latin ciphers': 'Cifrados latinos',
	'Equal values': 'Valores iguales',
	Word: 'Palabra',
	Meaning: 'Significado',
	...
	Factors: 'Factores',
	Weight: 'Peso',
	'Note on the source': 'Nota sobre la fuente',
