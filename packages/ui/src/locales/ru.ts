...
export const ru: Record<ChromeString, string> = {
	...
	'Mayan day sign': 'Знак дня майя',
	'Classic spelling': 'Классическое написание',
	'Highland spelling': 'Нагорное написание',
	Coefficient: 'Число дня',
	'Day sign': 'Знак дня',
	Trecena: 'Тресена',
	'Day {{n}} of {{total}}': 'День {{n}} из {{total}}',
	'Ruling sign': 'Знак-правитель',
	Correlation: 'Корреляция',
	Haab: 'Хааб',
	'Day of year': 'День года',
	'Long Count': 'Длинный счёт',
	'Calendar Round': 'Календарный круг',
	'Lord of the Night': 'Владыка ночи',
	'Year Bearer': 'Носитель года',
	'Mayan cross': 'Крест майя',
	'Offset in days': 'Смещение в днях',
	'Character of the number': 'Характер числа',
	Gentle: 'Мягкое',
	Indifferent: 'Среднее',
	Violent: 'Бурное',
	Center: 'Центр',
	'Conception arm': 'Плечо зачатия',
	'Destiny arm': 'Плечо судьбы',
	...
	'Vastu mandala': 'Мандала васту',
	'Vastu grid, north at the top and west on the left':
		'Сетка васту: север сверху, запад слева',
	'Entrance pada': 'Пада входа',
	Devata: 'Девата',
	Brahmasthan: 'Брахмастан',
	'Brahmasthan area': 'Площадь Брахмастана',
	'Area of one marma': 'Площадь одной Мармы',
	'Crossing points': 'Точки пересечения',
	'Outside the plot': 'За пределами участка',
	'Door pada': 'Пада двери',
	'Recommended padas': 'Рекомендуемые пады',
	'Counted from': 'Отсчёт от',
	Side: 'Сторона',
	Perimeter: 'Периметр',
	...
	Gematria: 'Гематрия',
	Cipher: 'Метод счёта',
	'Cipher values': 'Значения по методам счёта',
	Value: 'Значение',
	'Also published': 'Также публикуются',
	Tradition: 'Традиция',
	Source: 'Источник',
	Letters: 'Буквы',
	...
	Output: 'Результат',
	'Latin ciphers': 'Латинские методы счёта',
	'Equal values': 'Равные значения',
	Word: 'Слово',
	...
	'Ayurvedic constitution': 'Аюрведическая конституция',
	Dominant: 'Преобладающая',
	Secondary: 'Вторая по величине',
	Factors: 'Факторы',
	Weight: 'Вес',
	'Note on the source': 'Примечание к источнику',
	'Strongest graha': 'Самая сильная граха',
	Rank: 'Ранг',
	'{{value}} virupas': '{{value}} вирупы',
	Humours: 'Доши',
