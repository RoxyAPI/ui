...
export const RoxyHoroscopeCard = defineComponent({
	...
	props: {
		...
		submitUrl: { type: String as PropType<RoxyHoroscopeCardProps['submitUrl']> },
		submitContext: { type: Object as PropType<RoxyHoroscopeCardProps['submitContext']> },
		locationUrl: { type: String as PropType<RoxyHoroscopeCardProps['locationUrl']> },
		specUrl: { type: String as PropType<RoxyHoroscopeCardProps['specUrl']> },
		lang: { type: String as PropType<RoxyHoroscopeCardProps['lang']> },
		submitLabel: { type: String as PropType<RoxyHoroscopeCardProps['submitLabel']> },
		remember: { type: Boolean as PropType<RoxyHoroscopeCardProps['remember']> },
		attribution: { type: String as PropType<RoxyHoroscopeCardProps['attribution']> },
		hideReadings: { type: Boolean as PropType<RoxyHoroscopeCardProps['hideReadings']> },
		hideSections: { type: String as PropType<RoxyHoroscopeCardProps['hideSections']> },
	},
	setup(props) {
