...
export const RoxyNumerologyCard = defineComponent({
	...
	props: {
		...
		submitUrl: { type: String as PropType<RoxyNumerologyCardProps['submitUrl']> },
		submitContext: { type: Object as PropType<RoxyNumerologyCardProps['submitContext']> },
		locationUrl: { type: String as PropType<RoxyNumerologyCardProps['locationUrl']> },
		...
		remember: { type: Boolean as PropType<RoxyNumerologyCardProps['remember']> },
		attribution: { type: String as PropType<RoxyNumerologyCardProps['attribution']> },
		hideReadings: { type: Boolean as PropType<RoxyNumerologyCardProps['hideReadings']> },
		hideSections: { type: String as PropType<RoxyNumerologyCardProps['hideSections']> },
	},
	setup(props) {
