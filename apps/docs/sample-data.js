...
const samples = {
	...
	horoscope: {
		sign: "Aries",
		date: "2026-06-10",
		overview: "Saturn in Aries demands focus and discipline today. The effort you invest now builds something that endures. Embrace the structure and trust the slow progress. Rest and reflect. The next cycle begins soon.",
	...
	tarot: {
		...
		dailyMessage: "Your card for 2026-06-10: Six of Cups (reversed). living in the past, stuck memories, forgiveness, moving forward. Reversed, the Six of Cups warns when memory becomes a place to hide. The gentle looking-back of the upright card hardens into living in the past, a longing for how things used to be that pulls attenti...",
	},
	spread: {
		spread: "Three-Card",
		...
		positions: [
			{
				...
				card: {
					...
					meaning: "Reversed, The Devil is the card of the chain coming off. It often appears on the verge of a breakthrough, when a person is being called toward something larger but must first deal with the shadows that stand in the way. An addiction, a draining relationship, a self-imposed limiting belief, or a compulsion is being recognised for what it is and released. The grip that felt unbreakable upright is loosening, and the work is to confront the inner fears that kept it fastened and to let them go.\n\nThis release is rarely effortless. Reversed, the card can describe a deliberate descent into the darkest places of the self, undertaken consciously and with courage in order to understand what is hidden there and either release it or integrate it. Done with resistance or before one is ready, that confrontation can be destabilising, surfacing anxiety, dark thoughts, or a sense of being other than who one believed. Where this resonates, the card supports seeking qualified help.\n\nThe reversal can also point to a shadow kept secret out of shame, where relief comes from acknowledging it to a trusted person and from self-forgiveness. Underlying all of this is detachment: loosening the dependence on things, people, and outcomes without ceasing to care for them, and freeing oneself from the restrictions attachment imposes. Read reversed, The Devil returns the power that was given away, and the chains, always looser than they seemed, fall open.",
					love: "You are breaking free of a toxic pattern, codependency, or an attachment that held you back. Liberation from a bond built on fear rather than love becomes possible, and self-worth and independence are being reclaimed. The release may be painful, but it returns you to yourself. What remains after the chains lift is a connection that can be chosen freely.",
					career: "Freedom is being reclaimed from a toxic workplace, an oppressive role, or a path that compromised your integrity. The bargain that bound you is being refused in favour of something truer to who you are. Liberation of this kind is rarely comfortable, but it is necessary. Choosing principle over false security is what loosens the hold and opens the way out.",
					finances: "You are breaking free of financial bondage, debt, or an obsession with material things, and a healthier relationship with money is forming. The pursuit of security through possessions is being seen for the trap it was. The card affirms that real stability is built from within, not bought. Releasing the grip of greed or fear restores genuine financial freedom.",
					health: "Recovery is underway: a release from addiction, a harmful habit, or a self-destructive pattern that had taken hold. Liberation from what was damaging the body is reclaiming both health and autonomy. This is a powerful turning point, often the moment the grip finally breaks. Support the process, honour the courage it takes, and let the freedom consolidate.",
					spirituality: "You are confronting and integrating the shadow self, releasing fear, attachment, and self-imposed limitation. What was disowned is being met and either freed or woven back in constructively. This is a breakthrough on the spiritual path, the point at which a former captivity gives way. Detachment, practised with care, returns your power and opens the next stage of growth.",
					imageUrl: "./img/tarot/major/devil.jpg",
				},
			},
			{
				position: 2,
				...
				card: {
					...
					career: "A professional opportunity to expand is being declined in favour of the comfort zone. The reversed Two of Wands warns of timidity, poor planning, or staying small when a larger path is clearly available. Endless deliberation has replaced decision. Reconnect with the original ambition, build the missing plan, and find the courage to step beyond familiar ground before the opening closes.",
					finances: "Financial caution has tipped into limitation, with growth refused for the safety of the familiar. The reversed Two of Wands points to a lack of foresight, fear of a bigger move, or a sound idea left without a strategy to advance it. Playing it too safe is its own cost. Develop the concrete plan, weigh the larger goal honestly, and act rather than circling the decision.",
					health: "A health vision exists but the plan to reach it is missing, or fear stalls a needed change. The reversed Two of Wands describes drifting without a long-range strategy, or clinging to a comfortable routine that no longer serves the larger goal. Return to the original intention, build a concrete and committed plan, and take the step beyond the familiar that real progress requires.",
					spirituality: "Spiritual expansion is being avoided in favour of a comfortable but limiting routine. The reversed Two of Wands points to hesitation at the threshold of broader practice, the unknown territory of the path left unentered out of caution. The pull toward growth is genuine but unacted on. Reconnect with the deeper aspiration and venture past the familiar to reach the fuller experience it promises.",
			...
			},
			{
				...
				card: {
					...
					meaning: "In the Rider-Waite-Smith image, a young figure stands in a green field and gazes intently at a single pentacle held aloft in both hands, absorbed in it and insensible of all else around. Waite read the youth as moving slowly, looking fixedly at the coin, and gave the divinatory sense as application, study, scholarship, reflection, and, by another reading, news, messages, and the one who brings them. The Page is the student of the suit, the earnest beginner turning a tangible opportunity over in his hands.\n\nIn a reading, the Page of Pentacles announces a fresh start in the material realm: a new job, a course of study, a venture, a financial opening, or simply a growing awareness of how to build something real. The energy is that of beginning, the first stirring of interest and motivation rather than the finished achievement. A door has opened, and the card describes the curiosity and willingness to step through it.\n\nWhat sets this Page apart from the others is its groundedness. The dreams here are anchored to the practical and the achievable, with attention kept on tangible steps and feet planted on the earth. Common sense and a methodical approach turn possibility into a workable plan. The card favours patient, realistic effort over excitement that gets ahead of itself.\n\nThe Page of Pentacles is above all the avid student, ready to learn the skills a long-term ambition will require. The card invites taking a class, beginning an apprenticeship, or starting the slow accumulation of competence that an undertaking demands. Even an already capable person is encouraged to learn something new. The potential here is real and the enthusiasm genuine; the task is to ground it in steady, practical work.",
					love: "A new connection with grounded, practical energy, or a message about steadiness and commitment in love. This bond may begin slowly but holds real, tangible potential. The card favours patience and letting the relationship develop on solid ground rather than rushing it. Approach it with sincere curiosity and a willingness to build something dependable.",
					career: "A new role, course of study, or apprenticeship that promises real skill development. The card favours an eagerness to learn and a willingness to begin at the foundations. Embrace the student mindset, take the practical first steps, and treat the opening as the start of a long build rather than an instant arrival.",
					finances: "A new financial opportunity or the early stages of building wealth. The card favours starting small and proceeding with care: disciplined saving, sensible decisions, and patient attention to detail. This is a seed that needs deliberate nurturing. Lay practical foundations now, and let the prosperity grow from steady management.",
					health: "A new health or fitness routine begun with genuine enthusiasm and practical commitment. A beginners openness helps approach wellbeing without preconceived limits. The card favours small, consistent steps over ambitious overhaul. Start modestly, build the habit on solid ground, and let steady practice carry the progress.",
					spirituality: "A new study or practice begun with grounded, practical dedication. The card favours approaching spiritual development as an eager student rather than expecting immediate depth. Earthy, tangible practices suit this energy well. Begin patiently, keep the work connected to daily life, and let understanding accumulate through steady application.",
					imageUrl: "./img/tarot/minor/page-of-pentacles.jpg",
				},
			},
		],
		summary: "Your past (The Devil reversed) has shaped your present situation (Two of Wands reversed). The future (Page of Pentacles) suggests positive developments if you continue on this path.",
	},
	"tarot-catalog": {
		total: 78,
		limit: 12,
	...
	bio: {
		...
		spotlight: {
			...
			value: -97,
			phase: "trough",
			message: "Your emotional sensitivity is at its lowest point. You may feel detached, numb, or emotionally flat. This is a natural phase of emotional rest. Avoid making relationship decisions during this period and give yourself permission to withdraw and recharge.",
		},
		quickRead: {
			physical: -27,
			emotional: -97,
		...
		dailyMessage: "Your biorhythm for 2026-06-10: Energy rating 2/10 (Deep Recovery). Emotional cycle is recovery at -97%.",
		advice: "Honor this quiet period. Emotional energy will return naturally.",
	},
	hex: {
		number: 18,
		symbol: "䷑",
