...
const samples = {
		...
		positions: [
			...
			},
			{
				...
				card: {
					...
					imageUrl: "./img/tarot/minor/nine-of-pentacles.jpg",
				},
			},
			{
				position: 3,
	...
	hex: {
		...
		interpretation: {
			general: "A sudden shock or upheaval disrupts the normal order of things. The initial fright passes quickly for those who maintain their composure. After the shock, examine what it has revealed. Unexpected disruption can become the catalyst for important self-examination and renewed caution.",
			love: "Shocking developments may shake your relationship. Stay centered through the disturbance. After the thunder passes, the ability to laugh shows inner strength.",
			career: "Sudden events demand alert response. The initial shock may be frightening, but those who stay composed emerge well. Be prepared to move quickly.",
			decision: "Shock arrives, but do not panic. Stay centered through the disturbance. When the thunder passes, carry on as if nothing happened. Composure is key.",
			advice: "Thunder upon thunder teaches through shock. Fear first, then examine conduct. Those who remain composed through the shock may laugh afterward.",
		},
		changingLines: [
			{
				position: 1,
			...
			{
				position: 2,
				text: "Shock comes bringing danger. A hundred thousand times You lose your treasures And must climb the Change hills. Do not go in pursuit of them. After seven days you will get them back.",
			},
			{
				position: 3,
			...
			{
				position: 6,
				text: "Shock brings ruin and terrified gazing around. Going ahead brings misfortune. If is has not yet touched one's own body But has reached one's neighbor first, There is no blame. One's comrades have something to talk about.",
			},
		],
	},
	transits: {
	...
	yoga: {
		yogas: [
			...
			{
				id: "madhyavayasidhana",
				name: "Madhya Vayasi Dhana Yoga",
			},
			{
				id: "anthyavayasidhana",
			...
			{
				id: "yuddhatpoorvadridhachitta",
				name: "Yuddhatpoorvadridhachitta Yoga",
			},
			{
				id: "yuddhatpaschaddrudha",
				name: "Yuddhatpaschaddrudha Yoga",
			},
			{
				id: "satkathadisravana",
			...
			{
				id: "vichitrasaudhaprakara",
				name: "Vichitra Saudha Prakara Yoga",
			},
			{
				id: "ayatnagrihaprapta",
			...
			{
				id: "pitrusapasutakshaya",
				name: "Pitrusapa Sutakshaya Yoga",
			},
			{
				id: "matrusapasutakshaya",
				name: "Matrusapa Sutakshaya Yoga",
			},
			{
				id: "bhratrusapasutakshaya",
			...
			{
				id: "putrakalatraheena",
				name: "Putrakalatraheena Yoga",
			},
			{
				id: "bharyasahavyabhichara",
