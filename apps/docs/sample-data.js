...
const samples = {
	...
	horoscope: {
		sign: "Aries",
		date: "2026-07-12",
		overview: "Saturn teaches Aries through focused effort today. What feels heavy now becomes your greatest strength later. Trust the process of mastery and keep showing up. Rest and reflect. The next cycle begins soon.",
		love: "Venus in your sixth house shows love through acts of service. Small gestures of care mean more than grand declarations. Health-focused activities with a partner strengthen your bond. The Moon energizes your third house of communication and ideas.",
	...
	tarot: {
		...
		dailyMessage: "Your card for 2026-07-12: Four of Pentacles (reversed). letting go, overspending, greed, self-protection, release. Reversed, the Four of Pentacles loosens the closed fist of the upright card, and the result runs in more than one direction. Waite linked the reversal to suspense, delay, and opposition, but it most o...",
	},
	spread: {
		spread: "Three-Card",
		...
		positions: [
			...
			},
			{
				...
				card: {
					...
					finances: "A financial loss or shortfall has brought real disappointment, perhaps an investment gone wrong or resources unexpectedly drained. The Five of Cups does not minimise the setback. But it points past the spilled cups to what is still in hand. Take honest stock of remaining resources and let recovery begin from there rather than from the weight of the loss.",
					health: "Grief and sorrow are pressing on the body, the emotional weight of loss surfacing as low energy, sadness, or depletion. The Five of Cups asks you to let the grief move rather than suppress it, while remembering that healing remains possible. Tend the sorrow with care, then turn gently toward the reserves of vitality that have not been spent.",
					spirituality: "A spiritual grief or dark night of the soul is present, a sense of abandonment or doubt about the path. The Five of Cups honours the depth of this passage rather than hurrying past it. Painful as it is, such loss often carries the seed of deeper understanding. Let the sorrow be felt, and trust that something of value still stands behind it.",
					imageUrl: "./img/tarot/minor/five-of-cups.jpg",
				},
			},
			{
				position: 3,
		...
		summary: "Your past (The Empress) has shaped your present situation (Five of Cups). The future (Page of Cups) suggests positive developments if you continue on this path.",
	},
	"tarot-catalog": {
		total: 78,
		limit: 12,
	...
	bodygraph: {
		...
		profileDescription: "Heretic over Investigator. A conscious projection field leads others to assume a solution is already at hand, and the unconscious first line quietly supplies the foundation that can actually answer. Reputation is both the currency and the risk: with real preparation the practical solution lands far beyond the personal, and without it the same projection curdles into blame.",
		definition: "Single",
		...
		gates: [
			...
			},
			{
				...
				line: 5,
				gateName: "Confusion",
				gateDescription: "Head pressure from unresolved images of the past. The mind is crowded with fragments that do not yet fit, and gate 47 is where they finally resolve into meaning.",
				lineMeaning: "Others hand this line their confusion to hold. It can show what the new understanding is worth, and it drowns once it takes on more mental pressure than it can carry.",
			...
			},
			{
				...
				lineMeaning: "Struggle learned by picking sides and discovering which allies hold. Fighting alongside the right people sustains the effort; using them as fuel exhausts them and ends the alliance.",
			...
			},
			{
				...
				lineMeaning: "Values are traced back to where they came from. The splenic guardian examines the inherited rules first, keeping what still protects the group and dropping what only carries the past.",
				planetDescription: "The dominant activation. With the Earth it carries roughly 70 percent of the imprint on the chart. The Personality Sun gate is the conscious life theme, the Design Sun is the radiance the body broadcasts before a word is spoken.",
				ichingHexagram: {
					number: 50,
					english: "The Caldron",
			...
			},
			{
				...
				lineMeaning: "The foundation is accepting that confusion precedes order rather than signals failure. The new thing gets built by working through the parts, not by demanding the way be visible first.",
				planetDescription: "Always the wheel-opposite of the Sun, so it is derived rather than observed. It grounds whatever the Sun expresses, and the two Suns plus the two Earths fix the four gates of the incarnation cross.",
				ichingHexagram: {
					number: 3,
			...
			},
			{
				...
				lineMeaning: "Provocation aimed at the circle only when the timing is felt to be right. Believing that will alone can move an obstacle, regardless of the moment, wastes the charge entirely.",
				planetDescription: "The fastest body on the wheel, crossing it in about 28 days. It carries drive and the ongoing motion of the form, and it sets the timing for Lunar authority, which needs a full cycle before clarity arrives.",
				ichingHexagram: {
					number: 39,
					english: "Obstruction",
			...
			},
			{
				...
				lineMeaning: "Restriction used to rebuild the foundation before the network needs it again. Refusing to restructure while things are quiet means doing it anyway, later and under pressure.",
				planetDescription: "The communication imprint. The Personality Mercury gate is the message the person is here to deliver, the Design Mercury gate is how that expression actually sounds to everyone else.",
				ichingHexagram: {
					number: 48,
					english: "The Well",
			...
			},
			{
				...
				lineMeaning: "A composure that others read as being perfectly in flow. The rhythm being projected may not be the natural one, and once it produces nothing it is felt as stagnation and abruptly broken.",
				planetDescription: "Values and the moral floor under behavior. Personality Venus is what is consciously held dear, Design Venus is the standard the body applies without ever being consulted.",
				ichingHexagram: {
					number: 5,
	...
	"hd-type-card-profile": {
		...
		designKeynote: "Investigator: builds a secure foundation through study before acting.",
	},
	"hd-connection": {
		totalChannels: 6,
		channels: [
		...
		arrows: [
			{
				...
				colorMeaning: "Touch. Intake governed by contact and physical circumstance. What the body handles, and the state of the space it eats in, decide whether nourishment is absorbed or refused.",
				...
				cognition: {
					label: "Feeling",
					description: "Feeling. Recognition through the emotional and energetic frequency of a place or a person. The body registers atmosphere directly and reacts to what others do not notice.",
				},
				confident: true,
			},
			{
				...
				toneMeaning: "Judgment. A conclusion is reached first and only then spoken or acted on. Awareness weighs what is in front of it for quality and correctness before committing to it.",
				directionMeaning: "Observer. The body is nourished by taking the setting in from its own vantage point, relaxed and surveying, without needing to be at the center of it.",
			...
			},
			{
				...
				directionMeaning: "Peripheral. Awareness stays wide and ambient, registering context, atmosphere, and the side signals that sit outside whatever holds the center of attention.",
				baseName: "Integrative",
				confident: true,
			},
			{
				...
				layerDescription: "The mind-side half of Variable, covering the Perspective and Motivation arrows. It addresses awareness: how the mind is built to see and what colors that seeing, along with the false resonance of Distraction and Transference.",
				colorMeaning: "Desire. Awareness is motivated by what it wants and by what strikes it as worth pursuing. Owning that pull, rather than apologizing for it, is what points at the correct work.",
				toneMeaning: "Acceptance. Things are met as they are and weighed for whether they are correct, rather than corrected. Awareness takes in the whole and lets it be what it is.",
	...
	bio: {
		...
		dailyMessage: "Your biorhythm for 2026-07-12: Energy rating 4/10 (Low Energy). Physical cycle is high energy at 82%.",
