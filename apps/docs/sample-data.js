...
const samples = {
	...
	spread: {
		...
		positions: [
			...
			},
			{
				...
				card: {
					...
					meaning: "The World Reversed suggests that you are seeking closure on a personal issue. Perhaps you are still emotionally attached to a past relationship and want to move on. Or you dream of the day you can fit into your old skinny jeans but realize now that your metabolism and body shape changed in the last ten years. You know, deep down, that to accept and embrace where you are now, you need to let go of the past and move on. Finding closure may be an intensely personal journey – something you manage through journaling, visualization, energy work, and therapy.\n\nThe World Reversed can signify that you want to fulfil a big goal or complete a big project, but you’re not taking all the steps necessary to get there. You may opt for the easiest or quickest path to attain your goal, but it won't lead to the outcome you intend. Climbing a mountain from the bottom up is an entirely different experience from getting a helicopter ride to the peak, even though the destination is the same. You need to experience the trials and tribulations along the way so you can learn and grow. And when you do reach your goal, you will enjoy such a fantastic sense of achievement. Don’t be afraid to set stretch goals for yourself, even if it means enduring hardships or challenges along the way; it will make the victory even sweeter.\n\nThe World Reversed can also indicate a time when you are close to finishing a project or goal, but for whatever reason, you lose focus and slack off right at the end. You only have a short way to go, so why stop now? Re-energize and remind yourself how wonderful life will be when you get the thing you’ve wanted for so long.\n\nSometimes, The World Reversed can mean a frustrating delay in completing your projects. You might miss an essential piece, and you won’t find closure until it gets worked out. You may need to get more creative to figure out how to touch the finish line.",
					imageUrl: "./img/tarot/major/world.jpg",
				},
			},
			{
				position: 3,
		...
		summary: "Your past (Six of Swords reversed) has shaped your present situation (The World reversed). The future (Page of Pentacles) suggests positive developments if you continue on this path.",
	},
	bio: {
		date: "2026-05-10",
		seed: "roxy-ui-demo-2026-05-10",
	...
	hex: {
		...
		interpretation: {
			general: "You may find yourself in a subordinate or compromising position within a relationship or arrangement. Accept the situation with grace rather than demanding more than circumstances allow. Making the best of imperfect conditions requires wisdom and restraint.",
			love: "This is a secondary position in love, not the primary one. Accept the reality of your situation and find fulfillment in what is possible. Undertakings from this position face difficulty.",
			career: "You may be in a subordinate position with limited power. Understand your actual place and work within those constraints. Attempting what is beyond your position brings misfortune.",
			decision: "Major undertakings are not favored from your current position. Accept limitations and find what good you can accomplish. Know the bounds of your influence.",
			advice: "Thunder over the lake stirs but remains in place. Understand endings by seeing beginnings. Work within your circumstances rather than against them.",
		},
		changingLines: [
			{
				position: 1,
			...
			{
				position: 5,
				text: "The sovereign I gave his daughter in marriage. The embroidered garments of the princess Were not as gorgeous As those of the servingmaid. The moon that is nearly full Brings good fortune.",
			},
			{
				position: 6,
	...
	transits: {
		...
		transitPlanets: [
			...
			{
				name: "North Node",
				longitude: 335.252758567005,
				latitude: 0,
				sign: "Pisces",
				degree: 5.252758567005003,
				speed: -0.0529539,
				isRetrograde: true,
			},
			{
				name: "South Node",
				longitude: 155.252758567005,
				latitude: 0,
				sign: "Virgo",
				degree: 5.252758567005003,
				speed: -0.0529539,
		...
		transitAspects: [
			...
			},
			{
				...
				type: "SQUARE",
				angle: 90,
				orb: 0.5871146045593605,
				isApplying: false,
				strength: 91.61264850629485,
				nature: "challenging",
				interpretation: {
			...
			},
			{
				...
				type: "TRINE",
				angle: 120,
				orb: 1.3575702626570774,
				isApplying: false,
				strength: 83.03037171678653,
				nature: "harmonious",
				interpretation: {
			...
			},
			{
				...
				type: "TRINE",
				angle: 120,
				orb: 1.8774422090172607,
				isApplying: false,
				strength: 76.53197238728424,
				nature: "harmonious",
				interpretation: {
			...
			},
			{
				...
				type: "TRINE",
				angle: 120,
				orb: 3.2671315614392142,
				isApplying: false,
				strength: 59.16085548200982,
				nature: "harmonious",
				interpretation: {
			...
			},
			{
				...
				type: "SEMI_SQUARE",
				angle: 45,
				orb: 0.8870870737797532,
				isApplying: false,
				strength: 55.64564631101234,
				nature: "challenging",
				interpretation: {
			...
			},
			{
				...
				type: "SQUARE",
				angle: 90,
				orb: 3.1247910238697614,
				isApplying: false,
				strength: 55.36012823043198,
				nature: "challenging",
				interpretation: {
			...
			},
			{
				...
				type: "TRINE",
				angle: 120,
				orb: 6.1865478287927544,
				isApplying: true,
				strength: 22.66815214009057,
				nature: "harmonious",
				interpretation: {
			...
			},
			{
				...
				type: "TRINE",
				angle: 120,
				orb: 6.692430660681339,
				isApplying: false,
				strength: 16.344616741483264,
				nature: "harmonious",
				interpretation: {
