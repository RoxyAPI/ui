		...
		positions: [
			...
			},
			{
				...
				card: {
					...
					love: "Reckless romantic behavior, commitment avoidance, or a lover who is exciting but unreliable. The thrill of the chase replaces genuine emotional depth. Passion without reliability burns out quickly.",
					career: "Professional recklessness, job-hopping, or starting projects with fire that quickly burns out. Your career needs sustained commitment, not just initial enthusiasm. Finish what you start before chasing the next adventure.",
					finances: "Reckless financial risk-taking, impulsive spending on adventures, or financial instability from lack of follow-through. Your bold financial moves need grounding in reality. Enthusiasm is not a financial plan.",
					health: "Injuries from recklessness, burnout from unsustainable intensity, or health issues from an ungrounded lifestyle. Your fiery energy needs a stable foundation. Balance adventure with rest and recovery.",
					spirituality: "Spiritual restlessness, jumping between practices without depth, or using spiritual seeking as escapism. The fire of your seeking needs a hearth to burn in. Commit to one path and go deep.",
