...
const samples = {
	...
	horoscope: {
		sign: "Aries",
		date: "2026-06-07",
		overview: "Saturn asks Aries to take the mature path today. Shortcuts are tempting but discipline creates the real reward. Stand firm in your principles and the results will follow. Share what you have learned. Generosity and gratitude flow naturally.",
		love: "Venus warms your fourth house, bringing love into your home life. Domestic harmony and family connections feel nurturing. Cozy evenings and heartfelt conversations deepen bonds. The Moon retreats into your twelfth house of solitude and the subconscious.",
	...
	tarot: {
		...
		card: {
			...
			finances: "Financial deceptions or confusions are being revealed, and the fog around money is lifting. You can see the situation more clearly and address what was previously hidden. The reversal favours acting on this new clarity to correct course and make sound decisions. What was obscured is coming to light; use it to settle matters that uncertainty had left unresolved.",
			health: "Mental health is improving as fears and anxieties begin to release their hold. Clarity is returning about a condition that previously felt confusing, and sleep and emotional balance are steadying. The reversal favours continuing the inner work that surfaced and resolved what was buried. Tend the returning calm gently, and let the body settle as the unrest subsides.",
			spirituality: "You are emerging from a period of spiritual confusion or a dark night of the soul. Illusions are falling away and inner sight is clearing, so that true intuition can be told apart from fear-based projection. The reversal favours trusting your own inner voice over outside interpretation. As the fog lifts, the messages that once bewildered you begin to make sense.",
			imageUrl: "./img/tarot/major/moon.jpg",
		},
		dailyMessage: "Your card for 2026-06-07: The Moon (reversed). releasing fear, clarity returning, repressed emotion, inner confusion. Reversed, The Moon most often marks fear and illusion beginning to subside. The fog that distorted everything is thinning, and a person is working through the anxieties that had taken hold, understand...",
	},
	spread: {
		spread: "Three-Card",
		...
		summary: "Your past (Ten of Cups reversed) has shaped your present situation (Six of Cups). The future (Knight of Cups) suggests positive developments if you continue on this path.",
	},
	bodygraph: {
		type: "Generator",
	...
	bio: {
		...
		dailyMessage: "Your biorhythm for 2026-06-07: Energy rating 1/10 (Deep Recovery). Emotional cycle is low energy at -62%.",
	...
	hex: {
		...
		changingLines: [
			{
				position: 1,
				text: "Progressing, but turning back. Perseverance brings good fortune. If one meets with no confidence, one should remain calm. No mistake.",
			},
			{
				position: 2,
				text: "Progressing, but in sorrow. Perseverance brings good fortune. Then one obtains happiness from one's ancestress.",
			},
			{
				position: 3,
	...
	"angel-card": {
		number: "111",
		title: "New beginnings, manifestation power, and alignment with your highest purpose",
		coreMessage: "Your thoughts are manifesting rapidly. Focus on what you want, not what you fear. A powerful new chapter is beginning.",
		type: "repeating",
		digitRoot: 3,
		meaning: {
			spiritual: "Angel Number 111 is one of the most powerful manifestation numbers in the angelic realm. When you see this sequence, the universe is signaling that your thoughts are manifesting into reality at an accelerated rate. This is a cosmic wake-up call to pay close attention to your mental patterns. The number 1 represents new beginnings, leadership, and independence. When tripled as 111, these energies are amplified exponentially. Your angels are telling you that you're at a pivotal moment where your thoughts, beliefs, and intentions are being rapidly transformed into physical reality. This number also represents a gateway or portal opening in your life. You're being invited to step through into a new chapter filled with possibilities. The universe is taking a snapshot of your current mental state and using it as a blueprint for your future experiences.",
			love: "In matters of the heart, Angel Number 111 signals fresh starts and new romantic possibilities. If you're single, this number suggests that new love is on the horizon. The universe is preparing to introduce someone significant into your life, but you must first align your thoughts with the love you wish to receive. For those in relationships, 111 encourages you to reinvigorate your partnership with renewed passion and intention. It's time to have honest conversations about your shared future and set new goals together. Your thoughts about your relationship are particularly powerful right now. If you've been through a difficult breakup, 111 is a sign that healing and new beginnings are possible. Your angels want you to release past hurts and open your heart to love again.",
			career: "Professionally, Angel Number 111 indicates that new opportunities are emerging. This is the perfect time to start that business, apply for that position, or launch that creative project you've been contemplating. Your innovative ideas have divine support. The universe is encouraging you to take initiative and lead. Don't wait for permission or the \"perfect moment\"—now is your time to act. Your thoughts about success and abundance are manifesting, so ensure they're positive and expansive. Financially, 111 suggests that new income streams may be opening up. Stay alert to opportunities and trust your instincts when making money decisions. Your angels are guiding you toward prosperity.",
			twinFlame: "For twin flames, 111 is an extremely significant number indicating either imminent union or a major step forward in your journey. If you haven't met your twin flame yet, seeing 111 suggests that meeting is approaching. If you're in separation from your twin flame, 111 is a message of hope. It indicates that both of you are doing the necessary inner work and that reunion becomes more possible with each passing day. Focus on your own growth and trust divine timing. For twin flames already in union, 111 encourages you to set new intentions together. Your combined manifestation power is extraordinary—use it wisely to create the life you both desire.",
		},
		keywords: [
			"new beginnings",
			"manifestation",
		...
		energy: "positive",
		affirmation: "My thoughts are powerful. I choose to focus on what I desire.",
		actionSteps: [
			"Monitor your thoughts carefully—they're manifesting quickly into reality",
			"Set clear, positive intentions for what you want to create in your life",
			"Take inspired action on new opportunities that present themselves",
			"Release negative thought patterns and self-limiting beliefs",
			"Practice gratitude for what you already have while focusing on your desires",
		],
	},
	"angel-lookup": {
		number: "1212",
